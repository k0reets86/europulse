...
final class EPV2_Settings {
	...
	public static function defaults(): array {
		return [
			...
			'worker_cli_command' => 'python3 -m epv2_worker',
			'worker_src_dir' => '/root/projects/europulse/worker/src',
